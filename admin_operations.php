...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  if(isset($_GET['update']) && is_numeric($_GET['update'])){
    ...
    if (empty($validation->getErrors())) {
      ...
      $admin->setFirst_name($_POST['first_name'])->setLast_name($_POST['last_name'])->setEmail($_POST['email'])->setPassword($_POST['password'])->setPhone($_POST['phone'])->setgender($_POST['gender'])->setVerification_code($verification_code);
      if($admin->create()){
        ...
        if ($verificationCodeMail->send($_POST['email'], $subject, $body)) {
          ...
          header('location:check-verification-code.php?page=admin');
          die;
      } else {
      ...
      echo "<script>
      toastr.info('Admin Created Successfully');
      </script>";
        ...
        <?php } elseif (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <form action="" method="POST" class="w-75 mx-auto">
              ...
              <div class="col-12 form-group mb-1">
                <select class="form-control px-2" name="gender" id="">
